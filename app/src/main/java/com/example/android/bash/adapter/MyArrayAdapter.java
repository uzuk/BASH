package com.example.android.bash.adapter;
...
import com.example.android.bash.R;
import com.example.android.bash.model.MyDataModel;
...
public class MyArrayAdapter extends ArrayAdapter<MyDataModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.textViewName.setText(item.getClubName());
        vh.textViewCountry.setText(item.getRoomNumber());
